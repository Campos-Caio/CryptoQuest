...
class TestFrontendBackendIntegration:
    ...
    @pytest.mark.asyncio
    async def test_quiz_completion_flow(self, setup_system, test_data_manager, event_helper):
        ...
        try:
            ...
            mission_event = event_helper.create_mission_event(
                user_id,
                mission_id="quiz_mission_1",
                score=85.0,  # 85% de acerto
                mission_type="QUIZ",
                points_earned=100,
                xp_earned=50
            )
    ...
    @pytest.mark.asyncio
    async def test_perfect_score_badge_flow(self, setup_system, test_data_manager, event_helper):
    ...
    @pytest.mark.asyncio
    async def test_level_up_badge_flow(self, setup_system, test_data_manager, event_helper):
    ...
    @pytest.mark.asyncio
    async def test_multiple_events_flow(self, setup_system, test_data_manager, event_helper):
    ...
    @pytest.mark.asyncio
    async def test_error_handling_flow(self, setup_system, test_data_manager, event_helper):
        ...
        try:
            ...
            invalid_event = event_helper.create_mission_event(
                ...
                score=-10.0,  # Score inválido
                mission_type="QUIZ",
                points_earned=-50,  # Pontos negativos
                xp_earned=-25
            )
    ...
    @pytest.mark.asyncio
    async def test_performance_flow(self, setup_system, test_data_manager, event_helper):
